...
lda = LDA(k=2,                              # number of topics:the larger is the datasets, the greater is the number of topics, only if the datasets is representative of a diverse collection. The optimal number of topics is estimated by calculating topic coherence but it's time consuming, it is better to determine it heuristically.
